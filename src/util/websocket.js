...
// const host = `ws://134.209.241.50:8082/?uuid=${uuidv4()}` // process.env.NODE_ENV === 'production' ? window.location.host : 'localhost:8080'
...
// to the server
export const startWebsocketConnection = (host) => {
